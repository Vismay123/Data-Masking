...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$q = "insert into form1 (Country,patient_name,study_no,date,staff_name,patient_name1,clinic_regno,address,email_id,local_staff_contact,staff_mobile_no,
		...
		values ('$Country','$patient_name','$study_no','$date','$staff_name','$patient_name1','$clinic_regno','$address','$email_id','$local_staff_contact','$staff_mobile_no',
		'$dateMDT','$dateRFT','$SmearDiagnosis','$SmearDate','$mdiag','$type','$Age','$sex','$Weight','$Height','$BMI','$any_contra_indication_steroids','$able_to_attend_regularly',
		'$not_pregnant','$long_term','$inform_consent','$allocate_study_no','$history_of_enl','$others');";
	// echo $q;
